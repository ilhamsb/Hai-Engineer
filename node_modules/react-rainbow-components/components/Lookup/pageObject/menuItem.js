...
function () {
  ...
  (0, _createClass2["default"])(PageLookupMenuItem, [{
    ...
    value: function hover() {
      var itemElement = $("".concat(this.rootElement, " > a"));
      itemElement.moveTo();
    }
    /**
    ...
    value: function isActive() {
      return $(this.rootElement).getAttribute('class') === 'rainbow-lookup_menu-item rainbow-lookup_menu-item--active';
    }
    /**
