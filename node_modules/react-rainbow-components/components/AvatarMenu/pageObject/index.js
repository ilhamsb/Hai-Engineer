...
function () {
  ...
  (0, _createClass2["default"])(PageButtonMenu, [{
    ...
    value: function getItem(itemPosition) {
      var menuItems = $(this.rootElement).$$('li[role="presentation"]');
      ...
      if (menuItems[itemPosition]) {
        ...
        return new PageMenuItem("".concat(this.rootElement, " li[role=\"presentation\"]:nth-child(").concat(indexPosition + 1, ")"));
      }
