...
describe('formatDateTime', function () {
  ...
  it('should return the right formatted date', function () {
    ...
    expect((0, _formatDateTime["default"])(new Date('04/24/2019 13:23'))).toBe('04/24/2019, 1:23 PM');
    expect((0, _formatDateTime["default"])('04/24/2019 20:48')).toBe('04/24/2019, 8:48 PM');
  });
  it('should return the right formatted date when formatStyle large', function () {
    ...
    expect((0, _formatDateTime["default"])(new Date('04/24/2019 13:23'), 'large')).toBe('Wednesday, 04/24/2019, 1:23 PM');
    expect((0, _formatDateTime["default"])('04/24/2019 20:48', 'large')).toBe('Wednesday, 04/24/2019, 8:48 PM');
  });
  it('should return the right formatted date when formatStyle small', function () {
    ...
    expect((0, _formatDateTime["default"])(new Date('04/24/2019 13:23'), 'small')).toBe('4/24/19, 1:23 PM');
    expect((0, _formatDateTime["default"])('04/24/2019 20:48', 'small')).toBe('4/24/19, 8:48 PM');
  });
  it('should return the right formatted date when formatStyle is wrong', function () {
    ...
    expect((0, _formatDateTime["default"])(new Date('04/24/2019 13:23'), 'big')).toBe('04/24/2019, 1:23 PM');
    expect((0, _formatDateTime["default"])('04/24/2019 20:48', 'short')).toBe('04/24/2019, 8:48 PM');
  });
});