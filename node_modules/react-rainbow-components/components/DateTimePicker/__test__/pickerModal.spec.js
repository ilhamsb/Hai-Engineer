...
describe('<DateTimePickerModal/>', function () {
  ...
  it('should set 12:00 AM to TimeSelect when value is null and date is changed', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_pickerModal["default"], {
      isOpen: true
    }));
    component.find('Calendar').find('td').at(5).find('button').simulate('click');
    expect(component.find('TimeSelect').props().value).toBe('12:00 AM');
  });
  it('should fire OnChange when Ok button is clicked', function () {
