...
var _h = _interopRequireDefault(require("./styled/h2"));
...
function DateTimePickerModal(props) {
  ...
  var _useState3 = (0, _react.useState)((0, _extractTime["default"])(value)),
  ...
  (0, _react.useEffect)(function () {
    setDate(value);
    setTime(!value ? '' : (0, _extractTime["default"])(value));
  }, [isOpen, value]);
  (0, _react.useEffect)(function () {
    var currentDateTime = new Date("".concat((0, _extractDate["default"])(date), " ").concat(time));
    setModalTitle((0, _formatDateTime["default"])(currentDateTime, formatStyle, locale));
  ...
  }, _react["default"].createElement(_header["default"], null, _react["default"].createElement(_h["default"], null, modalTitle)), _react["default"].createElement(_responsiveContainer["default"], null, _react["default"].createElement(_calendar["default"], {
    value: date,
    locale: locale,
    minDate: minDate,
    maxDate: maxDate,
