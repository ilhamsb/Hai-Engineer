...
function () {
  ...
  (0, _createClass2["default"])(PageVisualPicker, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-visual-picker-option_content-container');

      if (items[itemPosition]) {
        return new PageVisualPickerOption("".concat(this.rootElement, " .rainbow-visual-picker-option_content-container:nth-child(").concat(itemPosition + 1, ")"));
      }
