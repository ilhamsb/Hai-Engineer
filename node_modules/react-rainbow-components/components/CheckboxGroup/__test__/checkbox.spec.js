...
describe('<CheckBox />', function () {
  it('it should set the right type to the input', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_checkbox["default"], {
      value: "test",
      label: "test"
    }));
  ...
  it('should pass a generated id to the input element and set the same id to the htmFor of the label element', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_checkbox["default"], null));
