...
function () {
  ...
  (0, _createClass2["default"])(PageCheckboxGroup, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-checkbox-group_checkbox');

      if (items[itemPosition]) {
        return new PageCheckboxItem("".concat(this.rootElement, " .rainbow-checkbox-group_checkbox:nth-child(").concat(itemPosition + 1, ")"));
      }
