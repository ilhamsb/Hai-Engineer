...
function () {
  ...
  (0, _createClass2["default"])(PageVerticalNavigation, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-vertical-item');

      if (items[itemPosition]) {
        return new PageVerticalItem("".concat(this.rootElement, " .rainbow-vertical-item:nth-child(").concat(itemPosition + 1, ")"));
      }
    ...
    value: function getSectionOverflow(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-vertical-section-overflow_container');

      if (items[itemPosition]) {
        return new PageVerticalSectionOverflow("".concat(this.rootElement, " .rainbow-vertical-section-overflow_container:nth-child(").concat(itemPosition + 1, ")"));
      }
