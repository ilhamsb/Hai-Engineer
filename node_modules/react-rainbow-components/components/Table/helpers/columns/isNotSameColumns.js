...
function isNotSameColumns(prevColumns, currentColumns) {
  ...
  return prevColumns.some(function (column, index) {
    ...
    return column.field !== field || column.type !== type || column.header !== header || column.defaultWidth !== defaultWidth || column.component !== component || column.sortable !== sortable || column.width !== width;
  });
}