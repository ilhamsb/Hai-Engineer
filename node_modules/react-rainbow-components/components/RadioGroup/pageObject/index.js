...
function () {
  ...
  (0, _createClass2["default"])(PageRadioGroup, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-radio-group_radio');

      if (items[itemPosition]) {
        return new PageRadioItem("".concat(this.rootElement, " .rainbow-radio-group_radio:nth-child(").concat(itemPosition + 1, ")"));
      }
