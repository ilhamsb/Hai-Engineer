...
describe('<TableWithBrowserPagination />', function () {
  it('should set the right class names when paginationAlignment is passed', function () {
    var paginationAlignments = ['center', 'left', 'right'];
    paginationAlignments.forEach(function (paginationAlignment) {
      ...
      expect(component.find("div[className=\"rainbow-table-with-browser-pagination_pagination-container rainbow-table-with-browser-pagination_pagination--".concat(paginationAlignment, "\"]")).exists()).toBe(true);
    });
  });
