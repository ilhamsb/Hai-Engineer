...
describe('<RadioButton />', function () {
  it('should set type radio to the input element', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_radioButton["default"], null));
  ...
  it('should set the name passed to the name prop of the input element', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_radioButton["default"], {
      name: "name-1"
    }));
  ...
  it('should have the right classNames when in the span element of the label when is disabled', function () {
    ...
    expect(component.find('span[className="rainbow-radio-button-group_radio-label rainbow-radio-button-group_radio-label--disabled"]').exists()).toBe(true);
  });
});