...
describe('<Marker />', function () {
  ...
  it('should have the right class names when it is visible', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_marker["default"], {
      isVisible: true
    }));
    expect(component.find('div').prop('className')).toBe('rainbow-radio-button-group_marker-container');
  ...
  it('should set the right position and size', function () {
    ...
    expect(component.find('span').prop('style')).toEqual(_objectSpread({}, style, {
      opacity: 1
    }));
  });
});