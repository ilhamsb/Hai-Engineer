...
function () {
  ...
  (0, _createClass2["default"])(PageRadioButtonGroup, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-radio-button-group_radio');

      if (items[itemPosition]) {
        return new PageRadioButtonItem("".concat(this.rootElement, " .rainbow-radio-button-group_radio:nth-child(").concat(itemPosition + 1, ")"));
      }
