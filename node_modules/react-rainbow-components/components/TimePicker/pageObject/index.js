...
function () {
  ...
  (0, _createClass2["default"])(PageTimePicker, [{
    ...
    value: function isOpen() {
      return $(timePickerModalId).isDisplayed() && $(timePickerModalId).$('button[id="time-picker_cancel-button"]').isDisplayed() && $(timePickerModalId).$('button[id="time-picker_ok-button"]').isDisplayed() && $(timePickerModalId).$('button[id="time-picker_up-button"]').isDisplayed() && $(timePickerModalId).$('button[id="time-picker_down-button"]').isDisplayed() && $(timePickerModalId).$('input[data-id="minutes"]').isDisplayed() && $(timePickerModalId).$('input[data-id="hour"]').isDisplayed() && $(timePickerModalId).$('input[data-id="input-element"]').isDisplayed();
    }
    /**
    ...
    value: function hasFocusAmPmSelect() {
      return $(timePickerModalId).$('fieldset[data-id="fieldset-element"]').isFocused();
    }
    /**
