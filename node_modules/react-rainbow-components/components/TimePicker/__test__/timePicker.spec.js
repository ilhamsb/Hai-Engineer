...
describe('<TimePicker/>', function () {
  ...
  it('should have the right class names when a custom className is passed', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], {
      label: "unit-testing-timePicker",
      className: "my-custom-class-name"
    }));
    expect(component.find('div.rainbow-time-picker_container.my-custom-class-name').exists()).toBe(true);
  });
  ...
  it('should call to focusHourInput when the modal is open', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], {
      label: "unit-testing-timePicker"
    }));
    component.find('input').simulate('click');
    ...
    setTimeout(function () {
      expect(component.instance().fieldRef.current.timeSelectRef.current.focusHourInput).toHaveBeenCalledTimes(1);
    }, 0);
  });
